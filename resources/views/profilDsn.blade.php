        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('lte')}}/dist/img/user3-128x128.jpg" class="user-image" alt="User Image">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="{{asset('lte')}}/dist/img/user3-128x128.jpg" alt="User profile picture">

              <h3 class="profile-username text-center">Sarah Bullock</h3>

              <p class="text-muted text-center">Lecturer</p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b class="fa fa-venus-mars"></b> <b class="pull-right">Perempuan</b>
                </li>
                <li class="list-group-item">
                  <b class="fa fa-star"></b> <b class="pull-right">Dosen Tetap</b>
                </li>
              </ul>
            </div>
            <!-- /.box-body -->
        ...
        <div class="col-md-9">
         <!-- About Me Box -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <strong><i class="fa fa-graduation-cap margin-r-5"></i>Dosen Program Studi</strong>
              ...
              <p class="text-muted">Jaksel, Jakarta</p>

              <hr>

              <strong><i class="fa fa-calendar margin-r-5"></i> Tanggal Lahir</strong>

              <p class="text-muted">2 Januari 1989</p>

              <hr>

              <strong><i class="fa  fa-map-pin margin-r-5"></i> Alamat Saat Ini</strong>

              <p class="text-muted">Jalan Mawar</p>

              <hr>

              <strong><i class="fa fa-envelope margin-r-5"></i> Email</strong>

              <p class="text-muted">sarah.bullock@staff.ukdw.ac.id</p>

              <hr>

              <strong><i class="fa fa-phone margin-r-5"></i> No Telp</strong>

              <p class="text-muted">083388931110</p>
