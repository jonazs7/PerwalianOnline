        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="{{asset('lte')}}/dist/img/user2-160x160.jpg" alt="User profile picture">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b class="fa fa-venus-mars"></b> <b class="pull-right">Laki-Laki</b>
                </li>
                <li class="list-group-item">
                  <b class="fa fa-star"></b> <b class="pull-right">Mahasiswa Aktif</b>
                </li>
              </ul>
            </div>
            <!-- /.box-body -->
         ...
         <!-- About Me Box -->
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">Jawa Barat, Bekasi</p>

              <hr>

              <strong><i class="fa fa-calendar margin-r-5"></i> Tanggal Lahir</strong>

              <p class="text-muted">25 Desember 2001</p>

              <hr>

              <strong><i class="fa  fa-map-pin margin-r-5"></i> Alamat Saat Ini</strong>

              <p class="text-muted">Jalan Sudirman</p>

              <hr>

              <strong><i class="fa fa-envelope margin-r-5"></i> Email</strong>

              <p class="text-muted">alexander.pierce@si.ukdw.ac.id</p>

              <hr>

              <strong><i class="fa fa-phone margin-r-5"></i> No Telp</strong>

              <p class="text-muted">082367289190</p>

              <hr>

              <strong><i class="fa fa-user margin-r-5"></i> Dosen Wali</strong>

              <p class="text-muted">Budi Sutedjo, S.Kom., M.M.</p>
